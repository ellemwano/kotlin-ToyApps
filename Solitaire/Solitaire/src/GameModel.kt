...
//        }
        ...
        // Replace tableau piles with new ones
        /*
    ...
    fun onWasteTap() {
        if (wastePile.size > 0) {
            ...
            // If we can play teh card, we remove it from teh waste pile
            if (playCard(card)) {
    ...
    fun onFoundationTap(foundationIndex: Int) {
        ...
        if (foundationPile.cards.size > 0) {
            ...
            // If we can play teh card, we remove it from the waste pile
            if (playCard(card)) {
    ...
    fun onTableauTap(tableauIndex: Int, cardIndex: Int) {
        ...
        // If tableau pile not empty, get the index of teh cards to move

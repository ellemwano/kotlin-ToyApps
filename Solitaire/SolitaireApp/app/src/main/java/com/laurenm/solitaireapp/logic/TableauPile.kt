...
/**
 * The 7 taleau piles (at the bottom of the game)
 */
...
class TableauPile(var cards: MutableList<Card> = mutableListOf())  {
    ...
    /**
     * Add card (from tableau pile) to foundation pile
     */
    ...
    /**
     * Move card(s) to other tableau pile
     */
...
// An empty tableauPile will only accept the King as the first card